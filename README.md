...
- payment
```
 http :8088/payments id="id" amount="amount" status="status" orderId="orderId" customerId="customerId" accountId="accountId" 
```
- account
```
 http :8088/accounts id="id" balance="balance" customerId="customerId" 
```
